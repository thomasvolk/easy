...
class HtmlPageSerializerTest extends WordSpecLike with MustMatchers {
  "an HtmlPageSerializer" must {
    "create a html page" in {
      ...
      htmlPage must include ("""<li class="parent"><a data-easy-page-id="/1/2/3" href="1/2/3.html">3 Parent</a></li>""")
      htmlPage must include ("""<li><a data-easy-page-id="/1/2/3/test-page/child1" href="1/2/3/test-page/child1.html">Subpage 1</a></li>""")
    }
  }
  "an HtmlPageSerializer" must {
    "create a page" in {
